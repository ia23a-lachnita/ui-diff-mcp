...
- Historical MVP model defaults were: locator `nvidia/LocateAnything-3B`, auditor `qwen/qwen3-vl-30b-a3b-instruct`, fast auditor `qwen/qwen3-vl-8b-instruct`, reviewer `google/gemini-2.5-flash-lite`, escalation `qwen/qwen3-vl-235b-a22b-instruct`, and free-only mode `nex-agi/nex-n2-pro:free` plus `nvidia/nemotron-nano-12b-v2-vl:free`. These paid OpenRouter defaults are superseded by the free-first, provider-explicit selection policy in `docs/superpowers/plans/2026-06-14-free-first-ui-diff-hardening.md`.
