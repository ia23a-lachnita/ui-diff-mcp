...
Legacy Gemini CLI using `gemini-3.1-pro-preview` reviewed the plan on 2026-06-15. For new reviews, use Antigravity/`agy` rather than the deprecated Gemini CLI.
